...
const auroraHolidays: Partner = {
  ...
  taglineSv: 'Utsjoki: stuga vid Tenos strand, med egen bastu',
  ...
  i18n: {
    ...
    fr: {
      ...
      description: 'La commune la plus au nord de la Finlande, à 450 km au nord du cercle polaire, et le premier lampadaire est trop loin pour gêner. Une entreprise familiale sámi avec ses propres chalets au bord de la rivière : deux chambres, sauna privé, de la place pour une famille de cinq, et des sorties aurores guidées de septembre à avril.',
      cta: 'Voir leur site',
      articleLabel: 'Lire l\'article',
      articleUrl: 'https://laplandvibes.com/fr/blog/aurora-holidays/',
    },
    it: {
      tagline: 'Utsjoki: chalet sulla riva del Teno, con sauna propria',
      description: 'Il comune più settentrionale della Finlandia, 450 km a nord del Circolo Polare, con il lampione più vicino troppo lontano per disturbare. Un\'impresa familiare sami con i propri chalet sul fiume: due camere, sauna privata, spazio per una famiglia di cinque persone e tour guidati dell\'aurora da settembre ad aprile.',
    ...
    nl: {
      ...
      description: 'De noordelijkste gemeente van Finland, 450 km ten noorden van de poolcirkel, en de dichtstbijzijnde straatlantaarn staat te ver weg om te storen. Een Sámi familiebedrijf met eigen hutten aan de rivier: twee slaapkamers, eigen sauna, plek voor een gezin van vijf en begeleide noorderlichttochten van september tot april.',
      cta: 'Bekijk hun site',
    ...
    ja: {
      ...
      description: 'フィンランド最北の自治体、北極圏から北へ450km。いちばん近い街灯は気にならないほど遠くにあります。サーミの家族経営による川辺の自社コテージ：寝室2つ、専用サウナ、5人家族でもゆったり。9月から4月まではガイド付きオーロラツアーも。',
      cta: '公式サイトを見る',
      articleLabel: '記事を読む',
    ...
    ko: {
      ...
      description: '핀란드 최북단 지자체, 북극권에서 북쪽으로 450km, 가장 가까운 가로등은 방해가 되지 않을 만큼 멀리 있습니다. 사미족 가족 기업이 직접 운영하는 강가 캐빈: 침실 2개, 전용 사우나, 5인 가족도 여유롭게. 9월부터 4월까지는 가이드 오로라 투어.',
      cta: '공식 사이트 보기',
      articleLabel: '기사 읽기',
