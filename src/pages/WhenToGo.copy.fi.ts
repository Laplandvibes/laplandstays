...
const copy: PageCopy = {
  ...
  ui: {
    ...
    catch: 'Mutta: pääsiäisviikko (maalis/huhtikuu vuodesta riippuen) menee täyteen, kotimainen matkailu täyttää mökit. Tavoittele maaliskuun kolmea ensimmäistä viikkoa, jos voit.',
