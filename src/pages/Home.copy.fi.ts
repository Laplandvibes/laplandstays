...
const copy: PageCopy = {
  "seo": {
    ...
    "description": "Missä yöpyä Lapissa: lasi-iglut, revontulimökit ja hotellit Levillä, Ylläksellä, Saariselällä ja Inarissa. Vertaa kyliä ja katso, mitä varata ensin."
  },
  "faq": {
