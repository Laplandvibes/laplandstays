...
const LOCALE_HEADLINES: Record<SupportedLang, { headline: string; description: string }> = {
  ...
  'zh-CN': {
    headline: '你好，我是Vesa 👋',
    description: 'LaplandVibes創始人。極光、秋色、聖誕季、極晝。我行遍拉普蘭，告訴你從哪裡開始、何時預訂什麼、哪些地方真正令人驚喜。',
  },
  ko: {
...
const LOCALE_DICTS: Record<SupportedLang, Required<NewsletterPopupDict>> = {
  ...
  'zh-CN': {
    ...
    successBody: '請在我們剛傳送的郵件中確認訂閱。',
    alreadyHeadline: '您已在訂閱列表中!',
    alreadyBody: '您的訂閱已經生效。有值得分享的內容時，我會告訴您。',
    ...
    closeAria: '關閉',
    closeLabel: '關閉',
    trust: '只在真正值得通知時傳送。隨時可取消。我們絕不分享您的電子郵件。',
    errorGeneric: '訂閱失敗。請重試。',
    socialLead: '在此期間，看看我在拉普蘭的動態：',
    founderAlt: 'LaplandVibes創始人Vesa',
    consent: `我同意 LaplandVibes 向我填寫的電子郵件地址傳送訂閱郵件，內容包括拉普蘭旅行建議、季節資訊和優惠資訊，並確認本人已年滿18週歲。`,
    privacy: `隱私政策`,
  },
  ko: {
