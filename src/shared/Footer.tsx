...
const CONTACT_FORM_COPY: Record<string, ContactFormCopy> = {
  ...
  'zh-CN': { name:'您的姓名', email:'您的電子郵件', subject:'主題', message:'留言', send:'傳送', sending:'傳送中…', successTitle:'已傳送!', successBody:'謝謝，我們將在 24–48 小時內回覆。', errorMsg:'出錯了，請重試。', close:'關閉', required:'請填寫所有欄位並提供有效電子郵件。', subj:{ error:'錯誤報告', partner:'合作諮詢', press:'媒體諮詢', general:'一般諮詢' } },
...
const BUILT_IN_SITE_LABELS: Record<string, Record<SiteLabelsKey, string>> = {
  ...
  'zh-CN': { hotelDeals:'精選飯店特惠',staysCabins:'住宿與小木屋',whereToStay:'玻璃屋、小木屋、荒野旅舍',familyFriendly:'家庭度假村與聖誕老人探訪',localFood:'薩米料理與野外採集食材',fineDining:'高階餐飲',barsPubs:'酒吧',activities:'精選北極活動',huskySafaris:'哈士奇雪橇之旅，運營商對比',skiResorts:'滑雪度假村對比',snowmobileTours:'雪地摩托之旅與租賃',spaWellness:'桑拿、水療、極光養生',nightlife:'夜生活',natureParks:'自然與公園',travelGuide:'旅行指南',christmas:'拉普蘭聖誕：聖誕老人村、極光',giftsSouvenirs:'禮品與紀念品',travelBlog:'旅行部落格',dealsOffers:'優惠',transport:'交通',carRental:'租車',workInLapland:'在拉普蘭工作' },
...
const EXT_SITE_LABELS: Record<string, Record<ExtLabelsKey, string>> = {
  ...
  'zh-CN': { luxuryVillas:'私人別墅與豪華小屋', tours:'導覽遊與一日遊', weddings:'北極婚禮', store:'拉普蘭精品店與手藝人', flights:'飛往拉普蘭的航班' },
...
const BUILT_IN_FULL_DICT: Record<string, Partial<typeof DEFAULT_DICT>> = {
  ...
  'zh-CN': {
    copyright: '{{year}} #LaplandVibes，#LaplandVibes 網路成員',
    tagline: '芬蘭拉普蘭旅遊指南，從北極光到午夜陽光。',
    getApp: '獲取應用',
    groups: { stay: '住', eatDrink: '吃喝', do: '玩', explore: '探索', essentials: '實用資訊' },
    travelGuideKicker: '拉普蘭旅遊指南',
    pillars: { northernLights: '北極光', huskySafaris: '哈士奇雪橇', skiResorts: '滑雪場', whereToStay: '住宿', thingsToDo: '玩樂', natureParks: '自然與公園', destinations: '目的地', categories: '分類', snowmobileTours: '雪地摩托之旅', hotels: '飯店', activities: '活動', flights: '航班', cars: '租車', packages: '套餐', summer: '夏季', findJobs: '查詢工作', seasonalWork: '季節性工作', employers: '僱主', movingToFinland: '移居芬蘭', workingConditions: '工作條件', livingInLapland: '拉普蘭生活' },
    about: { eyebrow: '關於 LaplandVibes', body: '從北極光到午夜陽光，芬蘭拉普蘭的權威指南。精選體驗、本地建議與註明來源的資訊，助您規劃北極之旅。', badge: '獨立運營 · 來源公開' },
    spottedError: { title: '發現錯誤了嗎？', body: '有需要修正的地方嗎？告訴我們，我們會立即更正。', cta: '報告錯誤 →' },
    partner: { title: '與我們合作', body: '在 25+ 個拉普蘭網站上投放廣告或開展合作。', cta: '聯絡我們 →' },
    press: { title: '媒體與新聞', body: '編輯合作與媒體資源包。', cta: '媒體諮詢 →' },
    affiliate: '本網站包含聯盟連結。如果您通過這些連結預訂，LaplandVibes 可獲得佣金，您無需支付額外費用。',
    legal: { privacy: '隱私政策', cookie: 'Cookie 政策', terms: '使用條款', contact: '聯絡方式' },
  },
  ko: {
...
export default function FooterWithNetworkJobs(props: React.ComponentProps<typeof SharedFooter>) {
  return (
    <>
      <JobNetworkBanner siteId="laplandstays" />
      <SharedFooter {...props} />
    </>
  );
}
