...
export const AD_SLOTS_COPY: Record<AdLocale, AdSlotsCopy> = {
  ...
  zh: {
    ...
    slotCount: (n) => `${n} 個廣告位`,
    slotOpen: '廣告位招商中',
    partnersDirTitle: '我們的合作伙伴',
    partnersDirLead: '在 LaplandVibes 網路中與我們合作的企業：贊助內容和廣告主，均標註為合作伙伴。',
    partnersDirEmptyTitle: '成為合作伙伴',
    partnersDirEmpty: '讓您的企業出現在規劃拉普蘭之旅的旅行者面前：贊助內容和網路中的推薦位。',
    subpageOpen: '您的廣告將全季展示在本頁',
    wantYourAd: '想在這裡展示您的廣告嗎？',
    sponsorSub: '成為主要合作伙伴：本站最顯眼的廣告位。',
    cardSub: '首頁廣告位：讓您的企業出現在拉普蘭旅行者面前。',
    premiumOpen: '廣告位招商中',
    bookCta: '預訂此廣告位 →',
    bookShort: '預訂 →',
  },
