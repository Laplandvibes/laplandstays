...
const NAME_I18N: Record<string, Record<string, string>> = {"laplandvibes.com":{"de":"Zentrale (Netzwerk-Startseite)","ja":"ハブ（ネットワークの拠点）","es":"Inicio (centro de la red)","pt-BR":"Início (centro da rede)","zh-CN":"主站（網路主頁）","ko":"메인 사이트(네트워크 홈)","fr":"Accueil (centre du réseau)","it":"Hub (centro della rete)","nl":"Hub (netwerkcentrum)","sv":"Nav (nätverkets startsida)"},"stayinlapland.com":{"de":"Übernachten in Lappland","ja":"ラップランドで泊まる","es":"Alojamiento en Laponia","pt-BR":"Hospedagem na Lapônia","zh-CN":"拉普蘭住宿","ko":"라플란드 숙박","fr":"Séjour en Laponie","it":"Soggiorno in Lapponia","nl":"Verblijf in Lapland","sv":"Bo i Lappland"},"laplandstays.com":{"de":"Hütten & Unterkünfte","ja":"コテージと宿泊","es":"Cabañas y alojamiento","pt-BR":"Chalés e hospedagem","zh-CN":"小木屋與住宿","ko":"오두막과 숙소","fr":"Chalets et hébergements","it":"Chalet e alloggi","nl":"Vakantiehuisjes & verblijven","sv":"Stugor & boenden"},"laplandhoteldeals.com":{"de":"Hotelangebote","ja":"ホテルのお得情報","es":"Ofertas de hoteles","pt-BR":"Ofertas de hotéis","zh-CN":"飯店優惠","ko":"호텔 특가","fr":"Offres d'hôtels","it":"Offerte hotel","nl":"Hotelaanbiedingen","sv":"Hotellerbjudanden"},"laplandluxuryvillas.com":{"de":"Luxusvillen","ja":"ラグジュアリーヴィラ","es":"Villas de lujo","pt-BR":"Vilas de luxo","zh-CN":"豪華別墅","ko":"럭셔리 빌라","fr":"Villas de luxe","it":"Ville di lusso","nl":"Luxe villa's","sv":"Lyxvillor"},"laplandhuskysafaris.com":{"de":"Husky-Safaris","ja":"ハスキーサファリ","es":"Safaris con huskies","pt-BR":"Safáris de huskies","zh-CN":"哈士奇雪橇之旅","ko":"허스키 사파리","fr":"Safaris en traîneau de huskies","it":"Safari con husky","nl":"Husky-safari's","sv":"Huskysafarier"},"laplandsnowmobile.com":{"de":"Schneemobilfahren","ja":"スノーモービル","es":"Motos de nieve","pt-BR":"Passeios de moto de neve","zh-CN":"雪地摩托","ko":"스노모빌","fr":"Motoneige","it":"Motoslitta","nl":"Sneeuwscooteren","sv":"Snöskoteråkning"},"laplandskiresorts.com":{"de":"Skigebiete","ja":"スキーリゾート","es":"Estaciones de esquí","pt-BR":"Estações de esqui","zh-CN":"滑雪度假村","ko":"스키 리조트","fr":"Stations de ski","it":"Stazioni sciistiche","nl":"Skigebieden","sv":"Skidorter"},"laplandactivities.fi":{"de":"Aktivitäten & Touren","ja":"アクティビティとツアー","es":"Actividades y excursiones","pt-BR":"Atividades e passeios","zh-CN":"活動與遊覽","ko":"액티비티와 투어","fr":"Activités et excursions","it":"Attività ed escursioni","nl":"Activiteiten & tours","sv":"Aktiviteter & turer"},"laplandtours.online":{"de":"Geführte Touren","ja":"ガイドツアー","es":"Tours guiados","pt-BR":"Passeios guiados","zh-CN":"導覽行程","ko":"가이드 투어","fr":"Visites guidées","it":"Tour guidati","nl":"Begeleide tours","sv":"Guidade turer"},"laplanddining.com":{"de":"Essen gehen","ja":"レストラン","es":"Restaurantes","pt-BR":"Restaurantes","zh-CN":"餐飲","ko":"다이닝","fr":"Restaurants","it":"Ristoranti","nl":"Uit eten","sv":"Äta ute"},"laplandfood.com":{"de":"Essen & regionale Produkte","ja":"食と地元の食材","es":"Gastronomía y productos locales","pt-BR":"Comida e produtos locais","zh-CN":"美食與當地特產","ko":"음식과 로컬 식재료","fr":"Cuisine et produits locaux","it":"Cibo e prodotti locali","nl":"Eten & streekproducten","sv":"Mat & lokala produkter"},"laplandbars.com":{"de":"Bars & Brauereien","ja":"バーとブルワリー","es":"Bares y cervecerías","pt-BR":"Bares e cervejarias","zh-CN":"酒吧與啤酒廠","ko":"바와 브루어리","fr":"Bars et brasseries","it":"Bar e birrifici","nl":"Bars & brouwerijen","sv":"Barer & bryggerier"},"laplandtransport.com":{"de":"Transport","ja":"交通","es":"Transporte","pt-BR":"Transporte","zh-CN":"交通","ko":"교통","fr":"Transport","it":"Trasporti","nl":"Vervoer","sv":"Transport"},"laplandcarrental.com":{"de":"Autovermietung","ja":"レンタカー","es":"Alquiler de autos","pt-BR":"Aluguel de carros","zh-CN":"租車","ko":"렌터카","fr":"Location de voiture","it":"Autonoleggio","nl":"Autoverhuur","sv":"Biluthyrning"},"laplandchristmas.com":{"de":"Weihnachten","ja":"クリスマス","es":"Navidad","pt-BR":"Natal","zh-CN":"聖誕","ko":"크리스마스","fr":"Noël","it":"Natale","nl":"Kerstmis","sv":"Jul"},"laplandwellness.com":{"de":"Wellness & Spa","ja":"ウェルネスとスパ","es":"Bienestar y spa","pt-BR":"Bem-estar e spa","zh-CN":"養生與水療","ko":"웰니스와 스파","fr":"Bien-être et spa","it":"Benessere e spa","nl":"Wellness & spa","sv":"Wellness & spa"},"laplandnightlife.com":{"de":"Nachtleben","ja":"ナイトライフ","es":"Vida nocturna","pt-BR":"Vida noturna","zh-CN":"夜生活","ko":"나이트라이프","fr":"Vie nocturne","it":"Vita notturna","nl":"Uitgaansleven","sv":"Nattliv"},"laplandweddings.online":{"de":"Hochzeiten","ja":"ウェディング","es":"Bodas","pt-BR":"Casamentos","zh-CN":"婚禮","ko":"웨딩","fr":"Mariages","it":"Matrimoni","nl":"Bruiloften","sv":"Bröllop"},"laplandgifts.com":{"de":"Geschenke & Souvenirs","ja":"ギフトとお土産","es":"Regalos y recuerdos","pt-BR":"Presentes e lembranças","zh-CN":"禮品與紀念品","ko":"선물과 기념품","fr":"Cadeaux et souvenirs","it":"Regali e souvenir","nl":"Cadeaus & souvenirs","sv":"Presenter & souvenirer"},"laplanddeals.com":{"de":"Angebote & Deals","ja":"セールとお得情報","es":"Ofertas y promociones","pt-BR":"Ofertas e promoções","zh-CN":"優惠與特價","ko":"할인과 특가","fr":"Bons plans et offres","it":"Offerte e promozioni","nl":"Deals & aanbiedingen","sv":"Erbjudanden & deals"},"laplandstore.fi":{"de":"Onlineshop","ja":"オンラインストア","es":"Tienda online","pt-BR":"Loja online","zh-CN":"線上商店","ko":"온라인 스토어","fr":"Boutique en ligne","it":"Negozio online","nl":"Webshop","sv":"Webbutik"},"laplandvisit.com":{"de":"Reiseführer","ja":"旅行ガイド","es":"Guía de viaje","pt-BR":"Guia de viagem","zh-CN":"旅行指南","ko":"여행 가이드","fr":"Guide de voyage","it":"Guida di viaggio","nl":"Reisgids","sv":"Reseguide"},"laplandnature.com":{"de":"Natur & Nationalparks","ja":"自然と国立公園","es":"Naturaleza y parques","pt-BR":"Natureza e parques","zh-CN":"自然與國家公園","ko":"자연과 국립공원","fr":"Nature et parcs","it":"Natura e parchi","nl":"Natuur & parken","sv":"Natur & nationalparker"},"laplandkids.com":{"de":"Familienreisen","ja":"家族旅行","es":"Viajes en familia","pt-BR":"Viagens em família","zh-CN":"親子旅行","ko":"가족 여행","fr":"Voyages en famille","it":"Viaggi in famiglia","nl":"Gezinsreizen","sv":"Familjeresor"},"laplandflights.fi":{"de":"Flüge nach Lappland","ja":"ラップランドへの航空券","es":"Vuelos a Laponia","pt-BR":"Voos para a Lapônia","zh-CN":"飛往拉普蘭的航班","ko":"라플란드행 항공편","fr":"Vols vers la Laponie","it":"Voli per la Lapponia","nl":"Vluchten naar Lapland","sv":"Flyg till Lappland"},"laplandwork.com":{"de":"Arbeiten in Lappland","ja":"ラップランドで働く","es":"Trabajar en Laponia","pt-BR":"Trabalhar na Lapônia","zh-CN":"在拉普蘭工作","ko":"라플란드에서 일하기","fr":"Travailler en Laponie","it":"Lavorare in Lapponia","nl":"Werken in Lapland","sv":"Jobba i Lappland"},"lapland.blog":{"de":"Reiseblog","ja":"旅行ブログ","es":"Blog de viajes","pt-BR":"Blog de viagem","zh-CN":"旅行部落格","ko":"여행 블로그","fr":"Blog voyage","it":"Blog di viaggio","nl":"Reisblog","sv":"Reseblogg"}};
...
const APP_I18N: Record<string, { title: string; stats: string[]; cta: string }> = {"en":{"title":"Everything Lapland. One app.","stats":["destinations","slopes","lifts"],"cta":"Get the free app"},"fi":{"title":"Everything Lapland. Yksi sovellus.","stats":["kohdetta","rinnettä","hissiä"],"cta":"Lataa ilmainen sovellus"},"sv":{"title":"Everything Lapland. En app.","stats":["resmål","backar","liftar"],"cta":"Hämta appen gratis"},"de":{"title":"Everything Lapland. Eine App.","stats":["Ziele","Pisten","Lifte"],"cta":"Kostenlose App holen"},"fr":{"title":"Everything Lapland. Une appli.","stats":["destinations","pistes","remontées"],"cta":"Obtenir l’appli gratuite"},"es":{"title":"Everything Lapland. Una app.","stats":["destinos","pistas","remontes"],"cta":"Consiga la app gratis"},"it":{"title":"Everything Lapland. Un’app.","stats":["destinazioni","piste","impianti"],"cta":"Scarica l’app gratis"},"nl":{"title":"Everything Lapland. Eén app.","stats":["bestemmingen","pistes","liften"],"cta":"Haal de gratis app"},"pt-BR":{"title":"Everything Lapland. Um app.","stats":["destinos","pistas","teleféricos"],"cta":"Baixar o app grátis"},"ja":{"title":"Everything Lapland. ひとつのアプリに。","stats":["目的地","ゲレンデ","リフト"],"cta":"無料アプリを入手"},"ko":{"title":"Everything Lapland. 하나의 앱에.","stats":["목적지","슬로프","리프트"],"cta":"무료 앱 받기"},"zh-CN":{"title":"Everything Lapland. 一個應用。","stats":["目的地","雪道","纜車"],"cta":"免費下載應用"}};
const CHROME_I18N: Record<string, Record<string, string>> = {"label":{"de":"Netzwerk","ja":"ネットワーク","es":"Red","pt-BR":"Rede","zh-CN":"站點網路","ko":"네트워크","fr":"Réseau","it":"Rete","nl":"Netwerk","sv":"Nätverk"},"heading":{"de":"Das gesamte Lappland-Netzwerk","ja":"ラップランド・ネットワーク全体","es":"Toda la red de Laponia","pt-BR":"Toda a rede da Lapônia","zh-CN":"整個拉普蘭站點網路","ko":"라플란드 네트워크 전체","fr":"Tout le réseau Laponie","it":"Tutta la rete Lapponia","nl":"Het hele Lapland-netwerk","sv":"Hela Lappland-nätverket"},"here":{"de":"Sie sind hier","ja":"現在のページ","es":"Está aquí","pt-BR":"Você está aqui","zh-CN":"當前位置","ko":"현재 위치","fr":"Vous êtes ici","it":"Si trova qui","nl":"U bent hier","sv":"Du är här"},"hint":{"de":"Alle Seiten des Netzwerks: hier!","ja":"ネットワークの全サイトはここから！","es":"¡Todos los sitios de la red, aquí!","pt-BR":"Todos os sites da rede: aqui!","zh-CN":"整個站點網路都在這裡！","ko":"네트워크의 모든 사이트가 여기에!","fr":"Tous les sites du réseau: ici !","it":"Tutti i siti della rete: qui!","nl":"Alle sites van het netwerk: hier!","sv":"Alla sajter i nätverket: här!"},"jump":{"de":"Zu einer Seite wechseln","ja":"サイトへ移動","es":"Ir a un sitio","pt-BR":"Ir para um site","zh-CN":"前往站點","ko":"사이트로 이동","fr":"Aller sur un site","it":"Vai a un sito","nl":"Ga naar een site","sv":"Gå till en sajt"},"search":{"de":"Website suchen…","ja":"サイトを検索…","es":"Buscar sitio…","pt-BR":"Buscar site…","zh-CN":"搜尋站點…","ko":"사이트 검색…","fr":"Rechercher un site…","it":"Cerca un sito…","nl":"Site zoeken…","sv":"Sök sajt…"},"noResults":{"de":"Keine Treffer.","ja":"該当なし","es":"Sin resultados.","pt-BR":"Sem resultados.","zh-CN":"無匹配結果","ko":"검색 결과 없음","fr":"Aucun résultat.","it":"Nessun risultato.","nl":"Geen resultaten.","sv":"Inga träffar."},"close":{"de":"Schließen","ja":"閉じる","es":"Cerrar","pt-BR":"Fechar","zh-CN":"關閉","ko":"닫기","fr":"Fermer","it":"Chiudi","nl":"Sluiten","sv":"Stäng"},"getApp":{"de":"App holen","ja":"アプリを入手","es":"Descargar la app","pt-BR":"Baixar o app","zh-CN":"獲取應用","ko":"앱 받기","fr":"Obtenir l'app","it":"Scarica l'app","nl":"Download de app","sv":"Hämta appen"}};
...
const CAT_I18N: Record<Cat, Record<string, string>> = {
  hub:       { en: 'Network hub', fi: 'Verkoston keskus', de: 'Netzwerk-Zentrale', ja: 'ネットワークの拠点', es: 'Centro de la red', 'pt-BR': 'Central da rede', 'zh-CN': '網路主頁', ko: '네트워크 허브', fr: 'Centre du réseau', it: 'Centro della rete', nl: 'Netwerkcentrum', sv: 'Nätverkets nav' },
  ...
  activity:  { en: 'Activities', fi: 'Tekeminen', de: 'Aktivitäten', ja: 'アクティビティ', es: 'Actividades', 'pt-BR': 'Atividades', 'zh-CN': '活動', ko: '액티비티', fr: 'Activités', it: 'Attività', nl: 'Activiteiten', sv: 'Aktiviteter' },
  food:      { en: 'Eat & drink', fi: 'Ruoka ja juoma', de: 'Essen & Trinken', ja: '食べる・飲む', es: 'Comer y beber', 'pt-BR': 'Comer e beber', 'zh-CN': '餐飲', ko: '먹고 마시기', fr: 'Manger et boire', it: 'Mangiare e bere', nl: 'Eten & drinken', sv: 'Äta & dricka' },
  ...
  season:    { en: 'Seasons & occasions', fi: 'Kaudet ja teemat', de: 'Saison & Anlässe', ja: '季節とイベント', es: 'Temporadas y ocasiones', 'pt-BR': 'Temporadas e ocasiões', 'zh-CN': '季節與場合', ko: '시즌과 이벤트', fr: 'Saisons et occasions', it: 'Stagioni e occasioni', nl: 'Seizoenen & gelegenheden', sv: 'Säsonger & tillfällen' },
  shopping:  { en: 'Shopping', fi: 'Ostokset', de: 'Einkaufen', ja: 'ショッピング', es: 'Compras', 'pt-BR': 'Compras', 'zh-CN': '購物', ko: '쇼핑', fr: 'Achats', it: 'Acquisti', nl: 'Shoppen', sv: 'Shopping' },
