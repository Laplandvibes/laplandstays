...
const copy: ChromeCopy = {
  nav: {
    ...
    cabins: 'Cabin Holidays',
  },
  hero: {
    eyebrow: 'Lapland Accommodation · Finland',
    h1: 'Where to Stay in Finnish Lapland',
    lead: 'A glass igloo where you watch the aurora from your pillow, a log cabin with your own sauna and the lake right outside, or a proper hotel in the village.',
  ...
  reviewedBy: {
    ...
    ariaLabel: 'Editorial attribution',
  },
  networkHub: {
