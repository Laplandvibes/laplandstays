...
const copy: ChromeCopy = {
  ...
  hero: {
    eyebrow: '拉普兰住宿 · 芬兰',
    h1: '芬兰拉普兰住宿指南',
    lead: '极光下的玻璃冰屋、松林中的极光木屋,以及带私人桑拿的拉普兰酒店。经过核实的100至1,500欧元/晚的房价,精选自莱维、于拉斯、萨利色尔卡和伊纳里。',
    leadSummer: '午夜阳光下的湖畔小屋、葱郁山丘间的河畔木屋,以及带私人桑拿的拉普兰酒店。经过核实的100至1,500欧元/晚的房价,精选自莱维、于拉斯、萨利色尔卡和伊纳里,只为漫长明亮的白夜。',
