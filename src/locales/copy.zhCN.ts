...
const copy: ChromeCopy = {
  ...
  pages: {
    home: {
      faq: [
        { q: '拉普兰玻璃冰屋每晚多少钱?', a: '芬兰拉普兰的玻璃冰屋每晚约250欧元(罗瓦涅米Nova Skyland)起,旺季在萨利色尔卡的Kakslauttanen Arctic Resort可达1,500欧元每晚。' },
        { q: '拉普兰最适合看北极光的住宿地是哪里?', a: '若想提高观赏极光的频率,请尽量向北。萨利色尔卡和伊纳里位于极光椭圆带之内,每年约有200个可见极光的夜晚。' },
        { q: '在拉普兰预算住宿大概多少钱?', a: '拉普兰的酒店和木屋连锁起价约100欧元/晚。Apukka Resort、Arctic SnowHotel等极光木屋淡季约150欧元/晚起。' },
        { q: '从木屋观赏北极光最佳时间是什么时候?', a: '芬兰拉普兰的极光季节从8月下旬持续到4月初。11月至2月提供最稳定的观赏窗口。' },
        { q: '拉普兰木屋和冰屋都有私人桑拿吗?', a: '是。芬兰拉普兰几乎每家木屋、别墅和别庄都配有自己的桑拿。烧柴、电桑拿或两者兼备。' },
        { q: '第一次到拉普兰最适合去哪个目的地?', a: '莱维入门最简单。直飞冬季航班到达基蒂莱机场,餐厅与商店在步行范围内,村庄出发的安全游项目齐全。' },
      ],
