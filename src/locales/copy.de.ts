...
const copy: ChromeCopy = {
  nav: {
    home: 'Start',
    propertyTypes: 'Unterkunftsarten',
  ...
  hero: {
    ...
    lead: 'Glasiglus unter dem Polarlicht, Nordlicht-Blockhütten im Kiefernwald und Lappland-Hotels mit eigener Sauna, geprüfte Übernachtungspreise von 100 € bis 1.500 €, handverlesen in Levi, Ylläs, Saariselkä und Inari.',
    leadSummer: 'Seehütten unter der Mitternachtssonne, Blockhütten am Fluss in den grünen Fjälls und Lappland-Hotels mit eigener Sauna, geprüfte Übernachtungspreise von 100 € bis 1.500 €, handverlesen in Levi, Ylläs, Saariselkä und Inari für die langen, hellen Nächte.',
  ...
  pages: {
    ...
    about: {
      ...
      lead: 'Wir leben hier. Wir übernachten hier. Wir aktualisieren diesen Reiseführer jede Saison und sagen Ihnen, wenn eine Unterkunft überbewertet ist.',
