...
const copy: ChromeCopy = {
  ...
  hero: {
    ...
    lead: 'En glasiglo där du ser norrskenet från kudden, en timmerstuga med egen bastu och sjön precis utanför, eller ett riktigt hotell i byn. Vi bor här uppe och har bott på de här ställena, så vi berättar vad de faktiskt kostar (från 100 till 1 500 € per natt) och vilka som är värda pengarna, i Levi, Ylläs, Saariselkä och Inari.',
    leadSummer: 'En sjöstuga under midnattssolen med egen bastu, en älvnära lodge i de gröna fjällen, eller ett riktigt hotell i byn. Vi bor här uppe och har bott på de här ställena, så vi berättar vad de faktiskt kostar (från 100 till 1 500 € per natt) och vilka som är värda pengarna, i Levi, Ylläs, Saariselkä och Inari.',
