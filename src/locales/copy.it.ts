...
const copy: ChromeCopy = {
  nav: {
    home: 'Home',
    propertyTypes: 'Tipi di alloggio',
  ...
  hero: {
    ...
    lead: "Iglù di vetro sotto l'aurora, chalet aurora boreale tra i pini e hotel della Lapponia con sauna privata, tariffe verificate da 100 € a 1.500 €/notte, selezionate a Levi, Ylläs, Saariselkä e Inari.",
    leadSummer: "Chalet in riva al lago sotto il sole di mezzanotte, lodge lungo il fiume tra i fjell verdi e hotel della Lapponia con sauna privata, tariffe verificate da 100 € a 1.500 €/notte, selezionate a Levi, Ylläs, Saariselkä e Inari per le lunghe notti chiare.",
  ...
  pages: {
    ...
    about: {
      ...
      lead: 'Viviamo qui. Soggiorniamo qui. Aggiorniamo questa guida ogni stagione e Le diciamo quando una struttura è sopravvalutata.',
