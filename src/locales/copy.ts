...
export function footerDict(lang: Lang): FooterDict {
  ...
  if (lang === 'zh-CN') {
    return {
      networkBadge: '芬蘭拉普蘭網路',
      tagline: '前往芬蘭拉普蘭旅行的權威數字指南。',
      groups: { stay: '住宿', eatDrink: '餐飲', do: '活動', explore: '探索', essentials: '實用資訊' },
      travelGuideKicker: '拉普蘭旅行指南',
      about: {
      ...
      spottedError: {
        title: '發現錯誤？',
        body: '看到需要糾正的內容？請告訴我們。我們會立刻修正。',
        cta: '報告錯誤 →',
      },
      partner: {
        title: '與我們合作',
        body: '在21+個拉普蘭相關網站投放廣告或開展合作。',
        cta: '聯絡我們 →',
      },
      press: {
        title: '媒體合作',
      ...
      siteLabels: {
        ...
        travelGuide: '旅行指南',
        christmas: '拉普蘭聖誕',
        giftsSouvenirs: '禮物與紀念品',
        travelBlog: '旅行部落格',
        dealsOffers: '優惠',
        transport: '交通',
        carRental: '汽車租賃',
        workInLapland: '在拉普蘭工作',
      },
    }
  }
  if (lang === 'ko') {
