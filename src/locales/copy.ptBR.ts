...
const copy: ChromeCopy = {
  nav: {
    home: 'Início',
    propertyTypes: 'Tipos de hospedagem',
    whenToGo: 'Quando ir',
  ...
  hero: {
    ...
    lead: 'Iglus de vidro sob a aurora, cabanas da aurora boreal no pinheiral e hotéis lapônios com sauna privativa, tarifas verificadas de €100 a €1.500/noite, selecionadas em Levi, Ylläs, Saariselkä e Inari.',
    leadSummer: 'Cabanas à beira do lago sob o sol da meia-noite, chalés à margem do rio nas colinas verdes e hotéis lapônios com sauna privativa, tarifas verificadas de €100 a €1.500/noite, selecionadas em Levi, Ylläs, Saariselkä e Inari para as longas noites claras.',
  ...
  pages: {
    ...
    about: {
      ...
      lead: 'Moramos aqui. Nos hospedamos aqui. Atualizamos este guia a cada temporada e contamos quando uma propriedade está superestimada.',
