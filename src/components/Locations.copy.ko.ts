...
const copy: Copy = {
    ...
    locations: [
      ...
      { name: '일래스', tagline: '때묻지 않은 노르딕 야생', description: '두 개의 봉우리, 핀란드에서 가장 긴 슬로프, 그러나 리조트 단지의 압도감은 없는 곳. 일래스는 한층 조용한 자매 마을입니다. Pallas-Yllästunturi 국립공원 가장자리에 흩어진 통나무 캐빈이 일래스 숙박의 주인공으로, 마을의 활기보다 고요함과 트레일 접근성을 중시하는 분께 이상적입니다.', highlights: ['크로스컨트리 왕국', '봉우리 뷰 샬레', '인파 없음'], priceFrom: '통나무 캐빈 1박 150€부터' },
