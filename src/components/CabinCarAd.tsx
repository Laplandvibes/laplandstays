...
const COPY: Record<Lang, Copy> = {
  ...
  en: {
    ...
    body: 'Many Lomarengas cabins sit on a fell slope or a lakeshore, and the shop, the slopes and the restaurant are a drive away. Pick the car up at the airport and return it to the same place.',
    pick: 'Pick up at the airport:',
    airports: ['Kittilä · Levi and Ylläs', 'Rovaniemi · Pyhä and Luosto', 'Ivalo · Saariselkä', 'Kuusamo · Ruka'],
    note: 'Rental companies compared; the final price shows before you book.',
  },
  sv: {
    adLabel: 'Annons',
    ...
    note: 'Hyrfirmorna jämförs, slutpriset visas innan du bokar.',
  },
  de: {
    adLabel: 'Anzeige',
    ...
    note: 'Vermieter im Vergleich, der Endpreis erscheint vor der Buchung.',
  },
  fr: {
    adLabel: 'Publicité',
    eyebrow: 'Un séjour en chalet demande une voiture',
    h2: 'Le chalet est rarement au centre du village',
    body: "Beaucoup de chalets Lomarengas sont à flanc de fjäll ou au bord d'un lac, et le magasin, les pistes et le restaurant sont à quelques minutes de route. Prenez la voiture à l'aéroport et rendez-la au même endroit.",
  ...
  it: {
    ...
    body: "Molti chalet Lomarengas sono sul pendio di un fjäll o in riva a un lago, e negozio, piste e ristorante sono a qualche minuto d'auto. Ritira l'auto in aeroporto e riconsegnala nello stesso posto.",
  ...
  es: {
    ...
    body: 'Muchas cabañas de Lomarengas están en la ladera de un fjäll o a orillas de un lago, y la tienda, las pistas y el restaurante quedan a un trayecto en coche. Recoge el coche en el aeropuerto y devuélvelo en el mismo sitio.',
    pick: 'Recogida en el aeropuerto:',
    airports: ['Kittilä · Levi y Ylläs', 'Rovaniemi · Pyhä y Luosto', 'Ivalo · Saariselkä', 'Kuusamo · Ruka'],
  ...
  nl: {
    ...
    body: 'Veel Lomarengas-hutten staan op een fjällhelling of aan een meer, en de winkel, de piste en het restaurant zijn een autorit verderop. Haal de auto op het vliegveld op en lever hem op dezelfde plek in.',
  ...
  'pt-BR': {
    ...
    body: 'Muitas cabanas da Lomarengas ficam na encosta de um fjäll ou à beira de um lago, e o mercado, as pistas e o restaurante ficam a uma curta viagem de carro. Retire o carro no aeroporto e devolva no mesmo lugar.',
  ...
  ja: {
    ...
    body: 'Lomarengasのコテージの多くは丘の斜面や湖畔にあり、店・ゲレンデ・レストランへは車で移動します。空港で借りて、同じ場所に返却できます。',
    pick: '空港で受け取り：',
  ...
  ko: {
    ...
    body: 'Lomarengas 캐빈 상당수는 구릉 비탈이나 호숫가에 있어 상점, 슬로프, 식당까지 차로 이동합니다. 공항에서 차를 받고 같은 곳에 반납하세요.',
    pick: '공항 픽업:',
  ...
  'zh-CN': {
    ...
    eyebrow: '小木屋度假需要一辆车',
    h2: '小木屋很少在村中心',
    body: 'Lomarengas 的许多小木屋位于山坡或湖畔，去商店、雪道和餐厅都要开车。在机场取车，同一地点还车。',
    pick: '机场取车：',
    airports: ['基蒂莱 · 莱维、于拉斯', '罗瓦涅米 · 皮哈、卢奥斯托', '伊瓦洛 · 萨利色尔卡', '库萨莫 · 鲁卡'],
    note: '比较多家租车公司，最终价格在预订前显示。',
  },
}
