...
const copy: Copy = {
    ...
    locations: [
      ...
      { name: '于拉斯', tagline: '原生态北欧荒野', description: '两座山、芬兰最长的雪道、没有度假村堆叠。于拉斯是更安静的姐妹。于拉斯的住宿是分布在Pallas-Yllästunturi国家公园里的原木小屋,适合更看重静谧与雪道入口、而非村庄热闹的旅人。', highlights: ['越野滑雪王国', '远眺雪山的木屋', '无人潮'], priceFrom: '原木小屋每晚150欧元起' },
