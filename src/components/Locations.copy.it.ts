...
const copy: Copy = {
    ...
    locations: [
      ...
      { name: 'Ylläs', tagline: 'Natura nordica intatta', description: "Due fjell, le piste più lunghe della Finlandia e nessuna sovrastruttura da resort, Ylläs è la sorella più silenziosa. Le strutture sono chalet di tronchi distribuiti nel parco nazionale Pallas-Yllästunturi, perfetti quando il silenzio e l'accesso alle piste contano più del trambusto del paese.", highlights: ['Regno dello sci di fondo', 'Chalet con vista sul fjell', 'Senza folla'], priceFrom: 'Chalet di tronchi a partire da 150 €/notte' },
