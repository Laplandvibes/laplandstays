...
const copy: Copy = {
    ...
    locations: [
      { name: 'Levi', tagline: 'Il cuore del lusso lappone', description: "La più grande stazione sciistica della Finlandia, con un paese a piedi alla base del fjäll. Le strutture vanno dagli appartamenti Lapland Hotels nel centro agli chalet ski-in e agli chalet di vetro di Levin Iglut, abbastanza vicini per la cena in paese, abbastanza lontani per osservare l'aurora con cielo scuro.", highlights: ['Chalet ski-in', 'Ristoranti e vita notturna', 'Menù completo di safari'], priceFrom: 'Hotel a partire da 100 €/notte · igloo di vetro a partire da 350 €' },
