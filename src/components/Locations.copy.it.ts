...
const copy: Copy = {
    ...
    locations: [
      { name: 'Levi', tagline: 'Il cuore del lusso in Lapponia', description: "La più grande stazione sciistica della Finlandia, con un paese a piedi alla base del fjäll. Le strutture vanno dagli appartamenti Lapland Hotels nel centro agli chalet ski-in e agli chalet di vetro di Levin Iglut, abbastanza vicini per la cena in paese, abbastanza lontani per osservare l'aurora con cielo scuro.", highlights: ['Chalet ski-in', 'Ristoranti e vita notturna', 'Menù completo di safari'] },
      { name: 'Ylläs', tagline: 'Natura nordica intatta', description: "Due fjäll, le piste più lunghe della Finlandia e nessuna sovrastruttura da resort, Ylläs è la sorella più silenziosa. Le strutture sono chalet di tronchi distribuiti ai margini del parco nazionale Pallas-Yllästunturi, perfetti quando il silenzio e l'accesso alle piste contano più del trambusto del paese.", highlights: ['Regno dello sci di fondo', 'Chalet con vista sul fjäll', 'Senza folla'] },
      { name: 'Saariselkä', tagline: "La porta dell'Artico", description: "Confina con il parco nazionale Urho Kekkonen, una delle ultime grandi aree selvagge d'Europa. Questa è la terra degli igloo di vetro di Saariselkä, Kakslauttanen, Star Arctic e Muotka, dove i tetti vetrati incontrano i fiumi della corsa all'oro e l'aria diventa davvero gelida.", highlights: ['Terra di igloo di vetro', 'Accesso al parco nazionale', "Zona profonda dell'aurora"] },
