...
const COPY = {
  ...
  'zh-CN': {
    eyebrow: '為何拉普蘭、為何現在',
    h2: '留下回憶的住宿',
    lead: '大多數旅行者只有一次北極之旅的機會。合適的小屋會讓它成為您十年裡都在講述的旅程。我們就是這樣幫您挑選的。',
    cta: '檢視可訂住宿',
    reasons: [
      { title: '編輯精選', body: '從芬蘭拉普蘭內部撰寫。容易遺忘的住宿被過濾掉。留下的是值得這趟飛行的小屋、別墅和旅館。' },
      { title: '合適的房型', body: '觀賞極光的玻璃小屋、萊維的滑入式木屋、追求寧靜的湖畔小屋。與旅程的真實需求相匹配。' },
      { title: '在可信平臺預訂', body: '每次搜尋都直接開啟可信的預訂合作方。價格透明、有免費取消視窗，以及您已熟知的保障。' },
    ],
  },
  de: {
  ...
  return (
    ...
    <section className="py-14 sm:py-20 lg:py-28 px-4 sm:px-6 bg-gradient-to-b from-white to-pink/5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-12">
          {c.reasons.map((r, i) => {
