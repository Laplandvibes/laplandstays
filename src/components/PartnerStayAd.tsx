...
const LOMARENGAS_COPY: Record<Lang, AdCopy> = {
  ...
  'zh-CN': {
    adLabel: '廣告',
    eyebrow: '整棟小屋，而非一間客房',
    headline: '在拉普蘭整棟租下一座小屋，帶專屬桑拿，全家都住得下',
    sub: '芬蘭最大的度假小屋租賃機構。拉普蘭各地有數千座小屋，許多帶湖畔專屬桑拿和壁爐。直接預訂，整座小屋歸你們，而不只是一間房。想要空間、安靜和自己的廚房時，小屋勝過飯店。',
    trust: ['多數帶專屬桑拿', '整棟租下，不與人共用', '小屋遍佈拉普蘭各地'],
    cta: '檢視可訂小屋',
    poweredBy: '由 Lomarengas 提供預訂',
  },
  ko: {
    adLabel: '광고',
...
const CARS_COPY: Record<Lang, AdCopy> = {
  ...
  es: {
    adLabel: 'Anuncio',
    eyebrow: 'Su propio ritmo en Laponia',
  ...
  'zh-CN': {
    adLabel: '廣告',
    eyebrow: '在拉普蘭按自己的節奏',
    headline: '機場租車，隨時前往雪山和極光',
    sub: '拉普蘭地廣人稀，公共交通班次很少。自駕就能隨時從飯店前往滑雪場、哈士奇農場和最佳極光地點，不必等巴士。機場直接取車，芬蘭的租車標配冬季輪胎。',
    trust: ['機場取車', '標配冬季輪胎', '比較租車公司'],
    cta: '檢視租車',
    poweredBy: '租車服務由 EconomyBookings 提供',
  },
  ko: {
    adLabel: '광고',
    eyebrow: '라플란드를 내 속도로',
