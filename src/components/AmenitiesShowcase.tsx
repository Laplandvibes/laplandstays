                ...
                <div className="mt-auto pt-3 border-t border-white/10 flex flex-wrap gap-2">
                  {amenity.examples.map((ex) => (
                    <a
                      ...
                      className="text-[12px] px-3 py-2 min-h-11 inline-flex items-center rounded-full bg-pink/10 text-pink font-semibold hover:bg-pink hover:text-white transition-colors"
                    >
                      {ex.name}
                    </a>
                  ))}
