...
const copy: Copy = {
    ...
    locations: [
      { name: 'Levi', tagline: 'Le cœur du luxe en Laponie', description: "La plus grande station de ski de Finlande, avec un village à pied au pied du fjell. L'offre s'étend des appartements Lapland Hotels au centre aux chalets ski-in et chalets de verre de Levin Iglut, assez près pour dîner au village, assez loin pour observer l'aurore sous un ciel noir.", highlights: ['Chalets ski-in', 'Restaurants et vie nocturne', 'Carte complète de safaris'], priceFrom: 'Hôtels à partir de 100 €/nuit · igloos de verre à partir de 350 €' },
      { name: 'Ylläs', tagline: 'Nature nordique préservée', description: 'Deux fjells, les plus longues pistes de Finlande, et aucun habillage de station, Ylläs est la sœur tranquille. Les hébergements sont des chalets en rondins éparpillés dans le parc national Pallas-Yllästunturi, parfaits quand le silence et l\'accès aux pistes priment sur l\'animation du village.', highlights: ['Royaume du ski de fond', 'Chalets avec vue sur le fjell', 'Sans foule'], priceFrom: 'Chalets en rondins à partir de 150 €/nuit' },
