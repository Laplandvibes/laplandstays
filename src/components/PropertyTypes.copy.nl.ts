...
const copy: Copy = {
    ...
    types: [
      ...
      },
      {
        ...
        short: 'Word wakker naast de piste.',
        body: 'Ski-in chalets en Lapland Hotels-appartementen in Levi, Ylläs en Pyhä, naar buiten, ski\'s aan, gaan. Restaurants op loopafstand, safari-pickup voor de deur.',
        priceFrom: 'vanaf €100/nacht',
      },
      {
